...
//	NSLog(@"%@", commitsJSON);
	...
	if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPad) {
	    ...
	    CDOMasterViewController *controller = (CDOMasterViewController *)masterNavigationController.topViewController;
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"SQKCoreDataOperation_Example" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SQKCoreDataOperation_Example.sqlite"];
