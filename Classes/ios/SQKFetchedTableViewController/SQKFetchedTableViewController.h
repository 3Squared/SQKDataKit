 ...
 * after the user has cancelled the search.
 */
...
/**
 Returns the appropiate NSFetchedResultsController (i.e. regular or search) for the given
 UITableView.
 ...
 *
 *  @return The sectionKeyPath to use in constructing a NSFetchedResultsController, or nil for no
 *sections.
 */
