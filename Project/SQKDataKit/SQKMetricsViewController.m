...
- (void)insertOrUpdateWithNaiveOperation {
    ...
    NaiveImportOperation *importOperation = [[NaiveImportOperation alloc] initWithContextManager:self.contextManager data:self.json];
...
- (void)insertOrUpdateWithOptimisedOperation {
    ...
    OptimisedImportOperation *importOperation = [[OptimisedImportOperation alloc] initWithContextManager:self.contextManager data:self.json];
